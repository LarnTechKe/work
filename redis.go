...
func redisKeyPeriodicSchedules(namespace string) string {
	return redisNamespacePrefix(namespace) + "periodic_schedules"
}

func redisKeyHistory(namespace string) string {
	return redisNamespacePrefix(namespace) + "history"
}

func redisKeyHistoryByName(namespace, jobName string) string {
	return redisNamespacePrefix(namespace) + "history:" + jobName
}

func redisKeyHistoryIndex(namespace string) string {
	return redisNamespacePrefix(namespace) + "history:index"
}
